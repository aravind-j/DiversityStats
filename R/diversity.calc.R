...
#' \insertCite{margalef_information_1973}{DiversityStats}} \item{Menhinick's Index
#' (\mjseqn{D_{Menhinick}}) \insertCite{menhinick_comparison_1964}{DiversityStats}}
#' \item{Berger–Parker Index (\mjseqn{D_{BP}})
#' \insertCite{berger_diversity_1970}{DiversityStats}} \item{Reciprocal Berger–Parker
#' Index (\mjseqn{D_{BP_{R}}}) \insertCite{magurran_measuring_2011}{DiversityStats}}
#' \item{Simpson's Index (\mjseqn{d})
#' \insertCite{simpson_measurement_1949,peet_measurement_1974}{DiversityStats}}
...
#' \insertCite{williams_patterns_1964,hill_diversity_1973}{DiversityStats}}
...
#' \insertCite{pielou_measurement_1966,hill_diversity_1973}{DiversityStats}}
#' \item{Shannon or Shannon-Weaver or Shannon-Wiener Diversity Index or Shannon entropy
#' (\mjseqn{H}) \insertCite{shannon_mathematical_1949,peet_measurement_1974}{DiversityStats}}
#' \item{Maximum Shannon-Weaver Diversity Index (\mjseqn{H_{max}})
#' \insertCite{hennink_interpretation_1990}{DiversityStats}} \item{Relative
#' Shannon-Weaver Diversity Index or Shannon Equitability Index (\mjseqn{H'})
#' or Pielou's Evenness (\mjseqn{J})
#' \insertCite{pielou_measurement_1966,hennink_interpretation_1990}{DiversityStats}}
#' \item{Effective number of species for the Shannon - Weaver Diversity Index
#' (\mjseqn{ENS_{H}}) or Hill's \mjseqn{N_{1}}
#' \insertCite{macarthur_patterns_1965,hill_diversity_1973}{DiversityStats}} \item{Heip's
#' Evenness Index (\mjseqn{E_{Heip}}) \insertCite{heip_new_1974}{DiversityStats}}
...
#' \insertCite{pielou_ecological_1975}{DiversityStats}} \item{Smith & Wilson's Evenness
#' Index (\mjseqn{E_{var}}) \insertCite{smith_consumers_1996}{DiversityStats}}
#' \item{Brillouin Diversity Index (\mjseqn{D_{Brillouin}})
#' \insertCite{brillouin_science_2013}{DiversityStats}} \item{Rényi Entropy
#' (\mjseqn{{}^q H_{Rényi}}) \insertCite{renyi_measures_1960}{DiversityStats}}
#' \item{Tsallis or HCDT Entropy (\mjseqn{{}^q H_{Tsallis}})
#' \insertCite{havrda_quantification_1967,daroczy_generalized_1970,tsallis_possible_1988}{DiversityStats}}
#' \item{Hill Numbers (\mjseqn{{}^q D})
#' \insertCite{hill_diversity_1973}{DiversityStats}} } \loadmathjax
#'
...
#'   \insertCite{margalef_information_1973}{DiversityStats} and Menhinick's Index
#'   (\mjseqn{D_{Menhinick}}) \insertCite{menhinick_comparison_1964}{DiversityStats}
#'
...
#'   follows \insertCite{hennink_interpretation_1990}{DiversityStats}.
#'
#'   \mjsdeqn{D_{max} = 1 - \frac{1}{k}}
#'
#'   Reciprocal of \mjseqn{d} gives the Simpson's reciprocal index
#'   (\mjseqn{D_{R}})
#'   \insertCite{williams_patterns_1964,hennink_interpretation_1990}{DiversityStats}
#'    and can range from 1 to \mjseqn{k}. This was also described in
#'   \insertCite{hill_diversity_1973;textual}{DiversityStats} as \mjseqn{N_{2}} or
...
#'   index (\mjseqn{H'}) \insertCite{hennink_interpretation_1990}{DiversityStats}
#'   is defined as follows \insertCite{peet_measurement_1974}{DiversityStats}.
#'
...
#'   \insertCite{shannon_mathematical_1949;textual}{DiversityStats} as follows.
#'
...
#'   \insertCite{shannon_mathematical_1949,peet_measurement_1974}{DiversityStats}.
#'
...
#'   individuals) \insertCite{hennink_interpretation_1990}{DiversityStats}.
#'
...
#'
#'   \insertCite{macarthur_patterns_1965;textual}{DiversityStats} described the Effective
...
#'   \insertCite{heip_new_1974}{DiversityStats}.
#'
...
#'   was described by \insertCite{mcintosh_index_1967;textual}{DiversityStats} as
#'   follows (\mjseqn{D_{Mc}}) \insertCite{peet_measurement_1974}{DiversityStats}.
#'
...
#'   \insertCite{pielou_ecological_1975;textual}{DiversityStats} as follows.
#'
...
#'   \insertCite{brillouin_science_2013}{DiversityStats}.
#'
...
#'   \insertCite{renyi_measures_1960}{DiversityStats}.
#'
...
#'   \insertCite{hill_diversity_1973}{DiversityStats}.
#'
...
#'   \insertCite{margalef_information_1973}{DiversityStats}}
#'   \item{menhinick_index}{Menhinick's Index (\mjseqn{D_{Menhinick}})
#'   \insertCite{menhinick_comparison_1964}{DiversityStats}}
#'   \item{berger_parker}{Berger–Parker Index (\mjseqn{D_{BP}})
#'   \insertCite{berger_diversity_1970}{DiversityStats}}
#'   \item{berger_parker_reciprocal}{Reciprocal Berger–Parker Index
#'   (\mjseqn{D_{BP_{R}}}) \insertCite{magurran_measuring_2011}{DiversityStats}}
...
#'   (\mjseqn{H_{max}}) \insertCite{hennink_interpretation_1990}{DiversityStats}}
...
#'   \insertCite{macarthur_patterns_1965,hill_diversity_1973}{DiversityStats}}
#'   \item{heip_evenness}{Heip's Evenness Index (\mjseqn{E_{Heip}})
#'   \insertCite{heip_new_1974}{DiversityStats}} \item{mcintosh_diversity}{McIntosh
#'   Diversity Index (\mjseqn{D_{Mc}})
#'   \insertCite{mcintosh_index_1967,peet_measurement_1974}{DiversityStats}}
#'   \item{mcintosh_evenness}{McIntosh Evenness Index (\mjseqn{E_{Mc}})
#'   \insertCite{pielou_ecological_1975}{DiversityStats}}
#'   \item{smith_wilson}{Smith & Wilson's Evenness Index (\mjseqn{E_{var}})
#'   \insertCite{smith_consumers_1996}{DiversityStats}}
...
#'   \insertCite{hill_diversity_1973}{DiversityStats}} \item{hill_number_1}{Hill Number
