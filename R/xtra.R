...
wlcm <-
  paste0("\n",
         "------------------------------------------",
         "--------------------------------------\n",
         "Welcome to DiversityStats version ",
         utils::packageDescription("DiversityStats")$Version, "\n",
         "\n", "\n",
         ...
         "  citation(package='DiversityStats')","\n",
         "\n",
         "# To suppress this message use:", "\n",
         "  suppressPackageStartupMessages(library(DiversityStats))", "\n",
         "--------------------------------------------",
         "------------------------------------\n")
