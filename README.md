...
[![Last-changedate](https://img.shields.io/badge/last%20change-2026--05--29-yellowgreen.svg)](https://github.com/aravind-j/DiversityStats/)
[![Zenodo
...
```
    ...
    To cite the R package 'DiversityStats' in publications use:
      ...
      Aravind, J., Roy, S., and Singh, A. M. ().  DiversityStats: Diversity Indices with Statistical Inference.
