...
knitr::include_graphics("https://raw.githubusercontent.com/aravind-j/DiversityStats/master/inst/extdata/DiversityStats.png") 
```
-->
...
###### Version : [`r getNamespaceVersion("DiversityStats")`](https://aravind-j.github.io/DiversityStats/); License: [GPL-2|GPL-3](https://www.r-project.org/Licenses/)
...
dver <- ifelse(test = gsub("(.\\.)(\\d+)(\\..)", "", getNamespaceVersion("DiversityStats")) != "",
               yes = getNamespaceVersion("DiversityStats"),
               no = gsub("Version:\\s*", "", readLines(paste0("https://raw.githubusercontent.com/", "aravind-j/DiversityStats", "/master/DESCRIPTION"))[grep("Version:", readLines(paste0("https://raw.githubusercontent.com/", "aravind-j/DiversityStats", "/master/DESCRIPTION")))]))

cat(paste("[![develVersion](https://img.shields.io/badge/devel%20version-", dver, "-orange.svg)](https://github.com/aravind-j/DiversityStats)", sep = ""))
```
[![Github Code Size](https://img.shields.io/github/languages/code-size/aravind-j/DiversityStats.svg)](https://github.com/aravind-j/DiversityStats)
...
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-yellowgreen.svg)](https://github.com/aravind-j/DiversityStats/)
[![Zenodo DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.zenodo.14889174.svg)](https://doi.org/10.5281/zenodo.20056661)
[![Website - pkgdown](https://img.shields.io/website-up-down-green-red/https/aravind-j.github.io/DiversityStats.svg)](https://aravind-j.github.io/DiversityStats/)
...
## Description
<!-- `r gsub("(<doi:)(.+)(>)", "[doi:\\2](https://doi.org/\\2)", gsub("\\n", " ", packageDescription("DiversityStats", fields = "Description")))` -->
`r gsub("\\n", "", pkgdown:::linkify(packageDescription("DiversityStats", fields = "Description")))`
...
# Install from CRAN
install.packages('DiversityStats', dependencies=TRUE)
```
...
```{r, echo = FALSE}
detach("package:DiversityStats", unload = TRUE)
suppressPackageStartupMessages(library(DiversityStats))
cit <- citation("DiversityStats")
